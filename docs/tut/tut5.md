...
pages, using [_Moonlight_](../apps/moonlight.md) instead of the
...
!!! hint "Restrictions on the number of concurrent _Moonlight_ users at http://remnrem.net/"
    ...
    [these instructions](../download/moonlight-install.md) to use locally either a Dockerized
...
This feature is a simple wrapper around Luna's [`MASK`](../ref/masks.md#mask) command,
...
The [next section](tut3.md#manipulating-edfs) of the original tutorial
...
| _Transform_       | [`TRANS`](../ref/evals.md#trans) | Arbitrary transformations of signals | 
...
The steps of the [original tutorial](tut3.md#artifact-detection) basically ran through the following commands
(in `cmd/sixth.txt`):
...
automated sleep staging) please visit [this page](../apps/moonlight.md).__
