...
| ZIP archive (60Mb) |
| ------------------------------------------------------------ |
| [http://zzz-luna.org/dist/luna/microstates/luna-ms-edfs.zip](http://zzz-luna.org/dist/luna/microstates/luna-ms-edfs.zip) | 
...
(The parameters used are listed in this file [GC data.04.(04).vrb](http://zzz-luna.org/dist/luna/microstates/GC_data.txt).  Below are the maps generated by
Cartool.
