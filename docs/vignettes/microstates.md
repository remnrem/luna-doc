...
| ZIP archive (60Mb) |
| ------------------------------------------------------------ |
| [http://zzz.nyspi.org/dist/luna/microstates/luna-ms-edfs.zip](http://zzz.nyspi.org/dist/luna/microstates/luna-ms-edfs.zip) | 
...
the [`MS`](../ref/ms.md#ms) command. You can see basic information using normal Luna
commands, e.g.:
...
locations) and the [`ltopo.rb()`](../ext/R/viz.md#ltoporb): 
...
(The parameters used are listed in this file [GC data.04.(04).vrb](http://zzz.nyspi.org/dist/luna/microstates/GC_data.txt).  Below are the maps generated by
Cartool.
...
Here we just use the [`MS`](../ref/ms.md#ms) command applied to the whole sample list,
