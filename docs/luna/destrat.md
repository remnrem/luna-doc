...
[_lunaR_](../ext/R.md) package to extract information from _lout_
files.
...
[_lunaR's_](../ext/R.md) `ldb()` function).
...
_LunaR's_ [`ldb()`](../ext/R.md#ldb) function can read _lout_ files
...
See the documentation on [`ldb()`](../ext/R.md#ldb) for more
information.
...
function [`ltxttab()`](../ext/R.md#ltxttab) which can facilitate
